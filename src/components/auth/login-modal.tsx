...
import { validateEmail, validatePassword, validateDisplayName } from '../../utils/validationUtils';
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 overflow-y-auto">
          ...
          >
            <div className="bg-background/95 backdrop-blur-xl border border-border/50 rounded-2xl shadow-2xl overflow-hidden">
              ...
              <div className="relative p-6 pb-0">
                ...
                <div className="text-center space-y-2">
                  ...
                  <h2 className="text-2xl font-semibold">
                    {hasEmailAuth && mode === 'register' ? 'Create an account' : 'Welcome back'}
                  </h2>
              ...
              {/* Email/Password Form (only if enhanced features available) */}
              {hasEmailAuth && (
                <>
                    ...
                    {mode === 'register' && (
                      <div>
                        ...
                        <input
                          ...
                          className={clsx(
                            "w-full px-4 py-2 rounded-lg border bg-background transition-colors",
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={clsx(
                            "w-full px-4 py-2 pl-10 rounded-lg border bg-background transition-colors",
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={clsx(
                            "w-full px-4 py-2 pl-10 pr-10 rounded-lg border bg-background transition-colors",
              ...
              {/* OAuth options */}
              <div className={clsx("p-6 space-y-3", !hasEmailAuth && "pt-6")}>
                {/* GitHub */}
                <motion.button
